...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $idebApprovalsAi->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $idebApprovalsAi->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="idebApprovalsAi form content">
            ...
            <fieldset>
                <legend><?= __('Edit Ideb Approvals Ai') ?></legend>
                <?php
